...
import pygame
from Tools import Background, Particle, Mouse, Sprite_Mouse_Location, Particle_2, Piano, load_image, Atom
import Map as Map
...
def two1():
    ...
    a = ['Мы находимся в ледяном лесу', 'Прослушай, как удивительно звучит его мелодия...',
         'Задобри Королеву Льда и найди эту мелодию в себе!']
    w00, h00 = 460, 430
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if a:
                    ...
                    if not gaga:
                        ...
                        Map.main()
                        sys.exit()
                if event.button == 1 and h == 0 and not a:
                    n = 0
                    for i in piano:
                        if pygame.sprite.collide_rect(i, mouse_sprite):
                            ...
                            i.update_on()
                        n += 1
            if event.type == pygame.KEYDOWN and not a:
